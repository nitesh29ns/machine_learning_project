...
ROOT_DIR = os.getcwd()  # to get current working dirctory

CONFG_DIR = "config"
CONFIG_FILE_NAME = "config.yaml"
CONFIG_FILE_PATH = os.path.join(ROOT_DIR,CONFG_DIR,CONFIG_FILE_NAME)

CURRENT_TIME_STAMP = f"{datetime.now().strftime('%Y-%m-%d-%H-%M-%S')}"

SCHEMA_FILE_NAME = "schema.yaml"
SCHEMA_FILE_PATH = os.path.join(ROOT_DIR,CONFG_DIR,SCHEMA_FILE_NAME)
...
DATA_INGESTION_DOWNLOAD_DIR_KEY = "dataset_download_url"
...
# data transformation relataed variables 
...
# data model training related variables
...
MODEL_PUSHER_EXPORT_KEY = "model_export_dir"
