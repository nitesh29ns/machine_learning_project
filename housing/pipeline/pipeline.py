...
from housing.logger import lg, get_log_file_name
    ...
    def run_pipeline(self):
        try:
            if Pipeline.experiment.running_status:
                lg.info("Pipeline is already running")
            ...
            lg.info(f"Pipeline experiment: {Pipeline.experiment}")
            ...
            if model_evaluation_artifact.is_model_accepted:
                ...
                lg.info("Trained model rejected.")
